;{var
  ...
  AppController = function AppController($scope, $timeout, $animate) {
  ...
  shuffleArray = function shuffleArray(array) {
    ...
    return array;
  };var selected1 = void 0,selected2 = void 0; // http://unicode.org/emoji/charts/full-emoji-list.html
  var iconAnimals = ['🐵', '🐶', '🐺', '🐱', '🐯', '🐴', '🐮', '🐷', '🐗', '🐭', '🐹', '🐰', '🐻', '🐨', '🐼', '🐔', '🐤', '🐦', '🐧', '🐸'];var iconFruits = ['🍇', '🍈', '🍉', '🍊', '🍋', '🍌', '🍍', '🍎', '🍏', '🍑', '🍒', '🍓'];var icons = iconAnimals;var app = angular // Using ngTouch to remove the 300ms click delay on mobile devices
  .module('app', ['ngRoute', 'ngAnimate', 'ngTouch']).controller('AppController', AppController);AppController.$inject = ['$scope', '$timeout', '$animate'];};