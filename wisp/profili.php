            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">HOTSPOT PROFILI/PONUDE</h4>
                                <p class="category">Korisnici se učitavaju iz baze WISP iz tablice PROFILI</p>
                            </div>
							<!-- Tablica s profilimA iz baze -->
							<div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    <thead>
                                        <th>Naziv</th>
                                    	<th>Download/upload limit</th>
                                    </thead>
									<!-- Vezanje tablice i baze za korisnike -->
									<?php include 'php/ispis_user_profile.php';?>
									<tbody>
                                    </tbody>
                                </table>
                            </div>
                            <div class="content">
                             <!-- Forma za dodavanje novih profila u hotspot i upis u DB -->
						<form action="php/hotspot/add_new_hotspot_user_profile.php" method="post">
							<h3>Dodaj novi profil</h3>	
							<label>ID</label>
							<input type="text" name="post_id"><br>							
							<label>Naziv</label>
							<input type="text" name="post_naziv"><br>
							<label>Download/upload limit</label>
							<input type="text" name="post_x"><br>
							<input type="submit" value="DODAJ PROFIL">
						</form>
