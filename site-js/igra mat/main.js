var Counter = {
    ...
    {
        return Math.round( Math.random(5)* multiplier)+1;
    },
    ...
    LoopThroughElements: function()
    {
        ...
        for (var index = 1; index < 5; index++)
        {
            ...
            if (index !== this.CorrectPosition)
            {
                do
                {
                    this.WrongAnswer = this.GenerateRandomNumber(5) + this.GenerateRandomNumber(5);
    ...
    Launch: function()
    {
        ...
        this.AddContentToElement("button#start-reset", "Kreni ispočetka");
        this.Refresh("aside#time-remaining > span", this.TimeRemaining);
        this.GenerateQuestionAndAnswers();
    },
    GenerateQuestionAndAnswers: function()
    {
        this.FirstNumber = this.GenerateRandomNumber(5);
        this.SecondNumber = this.GenerateRandomNumber(5);
    ...
    EventListener: function(event)
    {
        if ( Number(event.currentTarget.innerText) === Number(Counter.CorrectAnswer) )
        {
            ...
            Counter.AddContentToElement("p#message", "Točan odgovor!");
        }
        else
        {
            if (Counter.Score >= 1)
            ...
            Counter.AddContentToElement("p#message", "Pokušaj ponovno!");
        }
